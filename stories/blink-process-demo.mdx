...
<launch-setting name="type" label="If everything goes well, will web developers notice:">
  <option value="add">A new feature in the web platform</option>
  <option value="nochange">No change</option>
  <option value="remove">That a feature has been removed from the web platform</option>
</launch-setting>

<conditional-section condition="type=add">
...
<launch-setting name="sdo"
  label="Has your feature reached at least the Candidate Recommendation stage at the W3C, Stage 3 at TC39, or an equivalent stage at another standards body?"></launch-setting>

<conditional-section condition="sdo=no">
...
<conditional-section condition="type=remove">
...
#### Step 2: Coordinate with other engines
...
#### Step 4: Dev trial of deprecation
...
#### Step 5 (Optional): Deprecation Trial
...
<conditional-section condition="type=nochange">
### Web-developer-facing change to existing behavior

#### Before you begin: Assess backwards compatibility
